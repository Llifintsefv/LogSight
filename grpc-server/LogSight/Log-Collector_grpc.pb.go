...
const (
	LogCollector_SendLog_FullMethodName = "/Log_Collector.LogCollector/SendLog"
)
...
func (c *logCollectorClient) SendLog(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogResponse, error) {
...
func (UnimplementedLogCollectorServer) SendLog(context.Context, *LogRequest) (*LogResponse, error) {
...
func _LogCollector_SendLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogCollectorServer).SendLog(ctx, req.(*LogRequest))
	}
...
var LogCollector_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "Log_Collector.LogCollector",
